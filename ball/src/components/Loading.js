        ...
        <>
            <div className='loading'>
                ...
                <div className='single-square'>
                    <div className='arrow'><i className='fa fa-arrow-up'></i></div>
                </div>
                <div className='single-square'>
                    <div className='arrow' style={color ? {background:"green"}: null}><i className='fa fa-arrow-left'></i></div>
                    <div className='arrow'><i className='fa fa-arrow-down'></i></div>
                    <div className='arrow' style={color ? {background:"green"}: null}><i className='fa fa-arrow-right'></i></div>
                </div>
